...
export const defaultCreativeData = (): CreativeData => ({
  ...
  highlights: [
    ...
    '**34%** YoY growth in target markets',
  ...
  footerLine1: 'Your Company Name',
  footerLine2: 'www.yoursite.com',
  footerLine3: 'Your City · Your State · India',
  footerLine4: '',
  footerWebsite: 'www.yoursite.com',
  footerPhone: '+91 XXXXX XXXXX',
  footerEmail: 'hello@company.com',
  footerStyle: 'branded',
  footerAlign: 'split',
  footerFontSize: 11,
  footerLogoSize: 32,
