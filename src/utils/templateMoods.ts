...
export const TEMPLATE_MOOD_MAP: Record<TemplateId, TemplateMood[]> = {
  ...
  'villa-prestige': ['luxury', 'trust'],
  'penthouse-sky': ['luxury', 'social'],
  'commercial-hub': ['trust', 'urgent'],
  'plot-investment': ['trust', 'education'],
  'virtual-tour': ['urgent', 'social'],
  'rental-premium': ['trust', 'social'],
  'home-loan-pro': ['trust', 'education'],
  'reel-cover': ['social', 'urgent'],
  'linkedin-pro': ['trust', 'education'],
  'product-launch-pro': ['urgent', 'social'],
  'startup-pitch': ['trust', 'urgent'],
  'podcast-cover': ['social', 'education'],
  'event-poster': ['urgent', 'festival'],
  'flash-sale': ['urgent'],
  'brand-manifesto': ['luxury', 'trust'],
  'quarterly-pro': ['trust', 'education'],
  'kpi-command': ['trust', 'education'],
  'case-study-pro': ['trust', 'education'],
  'whitepaper-pro': ['education', 'trust'],
  'investor-snapshot': ['trust', 'luxury'],
  'art-deco-luxe': ['luxury'],
  'swiss-poster': ['luxury', 'education'],
  'synthwave-retro': ['social', 'festival'],
  'minimal-luxe': ['luxury', 'social'],
  'holographic-pro': ['social', 'urgent'],
}
