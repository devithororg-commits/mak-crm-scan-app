...
export const TEMPLATES: {
  ...
  { id: 'villa-prestige', name: 'Villa Prestige', desc: 'Ultra-luxury villa with gold frame overlay', preview: 'bg-gradient-to-br from-amber-900 to-black', bestFor: 'Premium Villas' },
  { id: 'penthouse-sky', name: 'Penthouse Sky', desc: 'Glass UI penthouse with city views', preview: 'bg-slate-950', bestFor: 'Luxury Apartments' },
  { id: 'commercial-hub', name: 'Commercial Hub', desc: 'Office & retail space listing', preview: 'bg-white border', bestFor: 'Commercial RE' },
  { id: 'plot-investment', name: 'Plot Investment', desc: 'Land investment with ROI metrics', preview: 'bg-emerald-950', bestFor: 'Land / Plots' },
  { id: 'virtual-tour', name: 'Virtual Tour', desc: '360° property tour invitation', preview: 'bg-slate-800', bestFor: 'Property Tours' },
  { id: 'rental-premium', name: 'Rental Premium', desc: 'Premium furnished rental card', preview: 'bg-slate-900', bestFor: 'Rentals' },
  { id: 'home-loan-pro', name: 'Home Loan Pro', desc: 'EMI offer with rate breakdown', preview: 'bg-indigo-950', bestFor: 'Home Loans' },
  { id: 'reel-cover', name: 'Reel Cover', desc: 'Instagram Reel cover with stats', preview: 'bg-gradient-to-br from-pink-500 to-orange-500', bestFor: 'Reels / Shorts' },
  { id: 'linkedin-pro', name: 'LinkedIn Pro', desc: 'Professional thought leadership post', preview: 'bg-[#f3f2ef]', bestFor: 'LinkedIn' },
  { id: 'product-launch-pro', name: 'Product Launch Pro', desc: 'Hero launch card with metrics', preview: 'bg-slate-950', bestFor: 'Product Launch' },
  { id: 'startup-pitch', name: 'Startup Pitch', desc: 'Investor pitch deck slide', preview: 'bg-white border', bestFor: 'Pitch Deck' },
  { id: 'podcast-cover', name: 'Podcast Cover', desc: 'Episode cover with guest info', preview: 'bg-gradient-to-br from-violet-600 to-indigo-800', bestFor: 'Podcasts' },
  { id: 'event-poster', name: 'Event Poster', desc: 'Event invite with date & venue', preview: 'bg-gradient-to-br from-violet-600 to-fuchsia-500', bestFor: 'Events' },
  { id: 'flash-sale', name: 'Flash Sale', desc: 'Countdown urgency sale poster', preview: 'bg-gradient-to-br from-red-600 to-orange-500', bestFor: 'Sales / Offers' },
  { id: 'brand-manifesto', name: 'Brand Manifesto', desc: 'Numbered belief statements', preview: 'bg-[#fafafa]', bestFor: 'Brand Story' },
  { id: 'quarterly-pro', name: 'Quarterly Pro', desc: 'Business quarterly report card', preview: 'bg-slate-900', bestFor: 'Reports' },
  { id: 'kpi-command', name: 'KPI Command', desc: 'Live dashboard metric grid', preview: 'bg-[#0B0F19]', bestFor: 'Dashboards' },
  { id: 'case-study-pro', name: 'Case Study Pro', desc: 'Before/after ROI case study', preview: 'bg-white border', bestFor: 'Case Studies' },
  { id: 'whitepaper-pro', name: 'Whitepaper Pro', desc: 'Research report download card', preview: 'bg-stone-50 border', bestFor: 'Research' },
  { id: 'investor-snapshot', name: 'Investor Snapshot', desc: 'Series A investor deck slide', preview: 'bg-gradient-to-br from-slate-950 to-indigo-950', bestFor: 'Investors' },
  { id: 'art-deco-luxe', name: 'Art Deco Luxe', desc: 'Gilded art deco luxury frame', preview: 'bg-[#1a1510]', bestFor: 'Luxury Brands' },
  { id: 'swiss-poster', name: 'Swiss Poster', desc: 'International typographic style grid', preview: 'bg-[#E8E4DE]', bestFor: 'Design / Posters' },
  { id: 'synthwave-retro', name: 'Synthwave Retro', desc: '80s neon grid sunset aesthetic', preview: 'bg-[#1a0a2e]', bestFor: 'Retro / Gaming' },
  { id: 'minimal-luxe', name: 'Minimal Luxe', desc: 'Whitespace luxury editorial', preview: 'bg-white border', bestFor: 'Luxury / Fashion' },
  { id: 'holographic-pro', name: 'Holographic Pro', desc: 'Iridescent prismatic gradient card', preview: 'bg-[#0a0a12]', bestFor: 'Tech / Creative' },
]
